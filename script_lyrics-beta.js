    ...
    searchBtn.addEventListener('click', () => {
      ...
      fetch(url, {
        ...
        .then((data) => {
          ...
          const apiKey = '7b39eab525b522700782c7f20e8a213a';
          const apiUrl = `https://api.musixmatch.com/ws/1.1/track.get?apikey=${apiKey}&track_isrc=${isrc}`;
          fetch(apiUrl)
            .then((response) => response.json())
            .then((data) => {
              // Extract relevant data from API response
            ...
            .catch((error) => {
              console.error('Erro na requisição da API da Musixmatch:', error);
            });
